...
namespace InjectionPayload {
    public static class RequestFilter {
        // mostly copied from https://github.com/abba23/spotify-adblock/blob/main/config.toml

        // blacklist for cef_urlrequest_create
        public static readonly Regex[] Blacklist = new[] {
        ...
        public static readonly Regex[] Whitelist = new[] {
